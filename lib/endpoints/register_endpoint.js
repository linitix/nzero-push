...
var deviceTokenSchema = JSONFileLoader.loadSync("device_token", "schema");
var channelSchema     = JSONFileLoader.loadSync("channel", "schema");

module.exports = function (deviceTokens, channels, callback, self) {
  var deviceTokensErrors = Utils.validateJSONWithSchema(deviceTokens, "device_token", deviceTokenSchema);
...
function registerDeviceTokensForChannels(deviceTokens, channels, callback, self) {
  var channelsErrors = Utils.validateJSONWithSchema(channels, "channel", channelSchema);
